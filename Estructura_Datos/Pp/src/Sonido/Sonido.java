...
public class Sonido{
    ...
    public Sonido(){     
        ...
        try {
            ...
            System.out.println("Falla constructor");
        }
    }
    ...
    public void reproducirBuho(Clip sonido){
        ...
        try {
            try {
                sonido.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonidos/Buho.wav")));
    ...
    public void reproducirGallo(Clip sonido){
        ...
        try {
            try {
                sonido.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonidos/Gallo.wav")));
            } catch (UnsupportedAudioFileException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void reproducirPerro(Clip sonido){
        ...
        try {
            try {
                sonido.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonidos/Perro.wav")));
            } catch (UnsupportedAudioFileException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void reproducirGato(Clip sonido){
        ...
        try {
            try {
                sonido.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonidos/Gato.wav")));
            } catch (UnsupportedAudioFileException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void reproducirOveja(Clip sonido){
        ...
        try {
            try {
                sonido.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonidos/Oveja.wav")));
            } catch (UnsupportedAudioFileException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void reproducirDelfin(Clip sonido){
        ...
        try {
            try {
                sonido.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonidos/Delfín.wav")));
            } catch (UnsupportedAudioFileException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void reproducirVaca(Clip sonido){
        ...
        try {
            try {
                sonido.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonidos/Vaca.wav")));
            } catch (UnsupportedAudioFileException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void reproducirSerpiente(Clip sonido){
        ...
        try {
            try {
                sonido.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/Sonidos/Serpiente.wav")));
            } catch (UnsupportedAudioFileException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
            } catch (IOException ex) {
                Logger.getLogger(Sonido.class.getName()).log(Level.SEVERE, null, ex);
