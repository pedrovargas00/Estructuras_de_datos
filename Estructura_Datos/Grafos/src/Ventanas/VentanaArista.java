...
public class VentanaArista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vértice 1");
        panel.add(jLabel1);
        jLabel1.setBounds(10, 30, 90, 15);

        jLabel2.setText("Vértice 2");
        panel.add(jLabel2);
        ...
        jButton1.setBounds(40, 140, 90, 25);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         if(x==y)
           JOptionPane.showMessageDialog(null,"Ingrese una arista diferente a: "+y);
         else if(x<0 || x>=i || y<0 || y>=i){
            JOptionPane.showMessageDialog(null,"Arista no válida"); 
         }else{
