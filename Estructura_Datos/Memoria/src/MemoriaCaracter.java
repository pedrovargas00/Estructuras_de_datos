...
public class MemoriaCaracter {
    
    private char memoria[];

    public MemoriaCaracter(int direccion) {
        this.memoria = new char[100];
        memoria[direccion] = ' ';
    }
    ...
    public void ingresar(char dato, int i, int j, int m, int tipo, int base){
    ...
    public void mostrarMemoria(int dato, int base){
        ...
        int x = base;
        System.out.println("Dirección -- Dato2");
